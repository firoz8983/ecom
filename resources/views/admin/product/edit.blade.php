                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                      <div class="custom-file">
                       ...
                       <center><br> <img src="{{Storage::url($product->image)}} " width="100"> </center>
                       <br>
                            @error('image')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                      ...
                      <input type="number" name="price" class="form-control @error('price') is-invalid @enderror " id="" aria-describedby="" value="{{$product->price}}">
                        @error('name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
